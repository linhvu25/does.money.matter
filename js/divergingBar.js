...
class DivergingBarChart {
  ...
  initVis() {
    ...
    // margin conventions
    vis.margin = { top: 50, right: 50, bottom: 80, left: 400 };
    ...
    if (vis.height < 400) vis.height = 600 - vis.margin.top - vis.margin.bottom;
    ...
    d3.select("#chart-type-select").on("change", () => {
      vis.updateVis();
    });
  ...
  updateVis() {
    ...
    var chart_type_select = document.getElementById("chart-type-select");
    var chart_type =
        chart_type_select.options[chart_type_select.selectedIndex].value;
    // console.log(chart_type)

    if(chart_type === "radial"){

      vis.svg.attr("transform", "translate(600,300)")

      vis.svg.selectAll(".bar").remove();
      vis.svg.selectAll(".candidate-label").remove();
      vis.svg.selectAll(".x-axis").remove();
      vis.svg.selectAll(".y-axis").remove();
      vis.svg.selectAll(".x-label").remove();
      vis.svg.selectAll(".y-label").remove();
      ...
      vis.svg.selectAll(".bar-labels").remove();

      vis.svg.attr("transform", "translate(400,50)")
      ...
      vis.bars1 = vis.svg.append("g")
          .selectAll(".bar.candidate1")
          .data(vis.barData)
      vis.bars1
          .enter()
          .append("rect")
      ...
      vis.bars2 = vis.svg.append("g")
          .selectAll(".bar.candidate2")
          .data(vis.barData)
      vis.bars2
          .enter()
          .append("rect")
